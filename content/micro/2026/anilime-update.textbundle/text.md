---
date: '2026-01-02T20:23:32'
showReadingTime: false
---

I've taken some time over the holiday break get my last 2025 update of [anilime](https://apps.apple.com/us/app/anilime/id1358133029) out to the store.  There was quite a bit of scope creep in this one:

- Expo Upgrade with a bunch of iOS 26 updates
- Moving the navigation stack to `@react-navigation`'s "native" implementations of [stack](https://reactnavigation.org/docs/native-stack-navigator) and [bottom tabs](https://reactnavigation.org/docs/native-bottom-tab-navigator)
